...
This repository intentionally avoids committing binary build artifacts (for example `*.jar`, `*.apk`, `*.aab`, keystores), to prevent "Binary files are not supported" errors in review tooling.
